      ...
      <div class="subscribe">
        ...
        <form role="form" method="POST" class="form-horizontal" action="{{ url('/') }}/generate">
          ...
          <div class="subscribe-form">
            <input class="date-own form-control" name="year" style="width: 400px;border:none" 
            type="text" placeholder="Click to pick a year" @if(isset($year)) value="
            {{ session()->get( 'year' ) }}" @endif>
